...
SECTOR_STOCK_FALLBACKS = {
    ...
    "半导体": [
        ("688981", "中芯国际"), ("688041", "海光信息"), ("688256", "寒武纪-U"), ("603986", "兆易创新"),
        ("002371", "北方华创"), ("688012", "中微公司"), ("300223", "北京君正"), ("688008", "澜起科技"),
    ],
    "先进封装": [
        ("002156", "通富微电"), ("600584", "长电科技"), ("002185", "华天科技"), ("688362", "甬矽电子"),
        ("300666", "江丰电子"), ("688072", "拓荆科技"), ("688012", "中微公司"), ("002371", "北方华创"),
    ],
    "氮化镓": [
        ("300456", "赛微电子"), ("300661", "圣邦股份"), ("600460", "士兰微"), ("002049", "紫光国微"),
        ("300373", "扬杰科技"), ("300623", "捷捷微电"), ("688396", "华润微"), ("002156", "通富微电"),
    ],
    "IGBT概念": [
        ("600460", "士兰微"), ("688396", "华润微"), ("300373", "扬杰科技"), ("300623", "捷捷微电"),
        ("300661", "圣邦股份"), ("002049", "紫光国微"), ("603290", "斯达半导"), ("688187", "时代电气"),
    ],
    "碳化硅": [
        ("600460", "士兰微"), ("688396", "华润微"), ("300373", "扬杰科技"), ("002049", "紫光国微"),
        ("300623", "捷捷微电"), ("688012", "中微公司"), ("002371", "北方华创"), ("300456", "赛微电子"),
    ],
    "华为海思": [
        ("300598", "诚迈科技"), ("300339", "润和软件"), ("300456", "赛微电子"), ("300053", "航宇微"),
        ("300379", "东方通"), ("300474", "景嘉微"), ("688981", "中芯国际"), ("603986", "兆易创新"),
    ],
    "中芯概念": [
        ("688981", "中芯国际"), ("002371", "北方华创"), ("688012", "中微公司"), ("688072", "拓荆科技"),
        ("300666", "江丰电子"), ("300604", "长川科技"), ("688126", "沪硅产业"), ("688037", "芯源微"),
    ],
    "抖音概念(字节概念)": [
        ("002555", "三七互娱"), ("002558", "巨人网络"), ("300058", "蓝色光标"), ("300364", "中文在线"),
        ("300418", "昆仑万维"), ("002624", "完美世界"), ("300315", "掌趣科技"), ("603000", "人民网"),
    ],
    "百度概念": [
        ("300496", "中科创达"), ("300033", "同花顺"), ("300418", "昆仑万维"), ("300058", "蓝色光标"),
        ("002230", "科大讯飞"), ("300212", "易华录"), ("002368", "太极股份"), ("600536", "中国软件"),
    ],
    "文娱消费": [
        ("002555", "三七互娱"), ("002558", "巨人网络"), ("300418", "昆仑万维"), ("300364", "中文在线"),
        ("002624", "完美世界"), ("300315", "掌趣科技"), ("603000", "人民网"), ("300133", "华策影视"),
    ],
    "元宇宙概念": [
        ("300418", "昆仑万维"), ("300364", "中文在线"), ("002555", "三七互娱"), ("002558", "巨人网络"),
        ("300315", "掌趣科技"), ("002624", "完美世界"), ("300496", "中科创达"), ("002241", "歌尔股份"),
    ],
    "谷子经济": [
        ("300251", "光线传媒"), ("300133", "华策影视"), ("300364", "中文在线"), ("002292", "奥飞娱乐"),
        ("002878", "元隆雅图"), ("002291", "遥望科技"), ("300058", "蓝色光标"), ("603000", "人民网"),
    ],
    "消费电子": [
        ("002475", "立讯精密"), ("002241", "歌尔股份"), ("000725", "京东方A"), ("002938", "鹏鼎控股"),
        ("300433", "蓝思科技"), ("002600", "领益智造"), ("603501", "韦尔股份"), ("002456", "欧菲光"),
    ],
    "光伏设备": [
        ("601012", "隆基绿能"), ("688599", "天合光能"), ("002459", "晶澳科技"), ("300274", "阳光电源"),
        ("300724", "捷佳伟创"), ("300751", "迈为股份"), ("002129", "TCL中环"), ("600438", "通威股份"),
    ],
    "玻璃基板": [
        ("000725", "京东方A"), ("000050", "深天马A"), ("002456", "欧菲光"), ("300433", "蓝思科技"),
        ("002600", "领益智造"), ("002938", "鹏鼎控股"), ("603501", "韦尔股份"), ("002241", "歌尔股份"),
    ],
    "传感器": [
        ("603501", "韦尔股份"), ("300456", "赛微电子"), ("300223", "北京君正"), ("002049", "紫光国微"),
        ("300373", "扬杰科技"), ("688008", "澜起科技"), ("300623", "捷捷微电"), ("002371", "北方华创"),
    ],
    "CPO概念": [
        ("300308", "中际旭创"), ("300502", "新易盛"), ("300394", "天孚通信"), ("002281", "光迅科技"),
        ("300570", "太辰光"), ("300620", "光库科技"), ("600498", "烽火通信"), ("000063", "中兴通讯"),
    ],
    "蓝宝石": [
        ("600703", "三安光电"), ("002273", "水晶光电"), ("300433", "蓝思科技"), ("300395", "菲利华"),
        ("300316", "晶盛机电"), ("002049", "紫光国微"), ("300456", "赛微电子"), ("300373", "扬杰科技"),
    ],
    "EDR概念": [
        ("002920", "德赛西威"), ("002594", "比亚迪"), ("601689", "拓普集团"), ("002050", "三花智控"),
        ("002463", "沪电股份"), ("002472", "双环传动"), ("601799", "星宇股份"), ("600699", "均胜电子"),
    ],
    "滨海新区": [
        ("600717", "天津港"), ("000695", "滨海能源"), ("000897", "津滨发展"), ("600821", "金开新能"),
        ("600322", "津投城开"), ("000652", "泰达股份"), ("000537", "中绿电"), ("002134", "天津普林"),
    ],
    "京津冀": [
        ("600717", "天津港"), ("000897", "津滨发展"), ("000652", "泰达股份"), ("000709", "河钢股份"),
        ("600008", "首创环保"), ("600266", "城建发展"), ("000786", "北新建材"), ("601000", "唐山港"),
    ],
    "上海自贸": [
        ("600648", "外高桥"), ("600018", "上港集团"), ("600822", "上海物贸"), ("600663", "陆家嘴"),
        ("600848", "上海临港"), ("600708", "光明地产"), ("600650", "锦江在线"), ("600284", "浦东建设"),
    ],
    "养殖业": [
...
def fallback_stocks_for_sector(theme_name, limit=8):
    ...
    if not stocks:
        ...
        elif any(key in theme_name for key in ["氮化镓", "IGBT", "碳化硅"]):
            stocks = SECTOR_STOCK_FALLBACKS.get(theme_name) or SECTOR_STOCK_FALLBACKS["氮化镓"]
        elif any(key in theme_name for key in ["CPO", "光通信", "算力"]):
            stocks = SECTOR_STOCK_FALLBACKS["CPO概念"]
        elif any(key in theme_name for key in ["芯", "半导体", "封装", "海思", "中芯", "存储", "晶圆", "传感器", "蓝宝石", "玻璃基板"]):
            stocks = SECTOR_STOCK_FALLBACKS["半导体"]
        elif any(key in theme_name for key in ["抖音", "字节", "游戏", "传媒", "短剧", "文娱", "元宇宙", "谷子"]):
            stocks = SECTOR_STOCK_FALLBACKS["抖音概念(字节概念)"]
        elif "百度" in theme_name:
            stocks = SECTOR_STOCK_FALLBACKS["百度概念"]
        elif any(key in theme_name for key in ["光伏", "HJT", "TOPCon"]):
            stocks = SECTOR_STOCK_FALLBACKS["光伏设备"]
        elif any(key in theme_name for key in ["EDR", "汽车电子", "智能驾驶"]):
            stocks = SECTOR_STOCK_FALLBACKS["EDR概念"]
        elif any(key in theme_name for key in ["滨海", "天津", "京津冀", "自贸", "新区"]):
            stocks = SECTOR_STOCK_FALLBACKS.get(theme_name) or SECTOR_STOCK_FALLBACKS["滨海新区"]
        elif any(key in theme_name for key in ["消费电子", "苹果", "华为", "电子"]):
            stocks = SECTOR_STOCK_FALLBACKS["消费电子"]
