...
```text
http://127.0.0.1:8790/api/live
```

它会读取东方财富 BK 板块资金、腾讯指数行情和核心候选池价格，按市场门、情绪阶段、核心候选规则输出盘中动作。前端默认 60 秒刷新一次。
...
https://your-site.vercel.app/api/live
```
...
- 盘中实时判断：按 60 秒口径刷新指数门、板块情绪和核心候选快照。
